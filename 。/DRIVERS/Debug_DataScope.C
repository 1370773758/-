...
DataType_e Debug_DataType = DataType_ChassisData;//可以在debug的时候直接修改该值实现切换数据 
//static uint8_t DelayTime = 40;
//void Task_DebugShow(void) {
//	while (true)
//	{
//		delay_ms(DelayTime / 4);//过低时会造成发送丢包失败。
...
//		{
//			
////			Debug_addData(M6020_Pitch.targetAngle, 1);
////			Debug_addData(M6020_Pitch.totalAngle, 2);
////			Debug_addData(M6020_Pitch.pid_Angle.err, 3);

////			Debug_addData(Cloud.YawAttitude_pid.err, 4);
////			Debug_addData(IMU_Cloud.totalYaw, 5);
////			Debug_addData(Cloud.IMUtargetYawLPF, 6);
////			Debug_show(6);
//		}
//		else if (Debug_DataType == DataType_ChassisData)
//		{
//			
////			Debug_addData(M3508s[3].realSpeed, 1);
////			Debug_addData(IMU_Chassis.Gyro.z, 2);
////			Debug_addData(IMU_Chassis.Gyro.z, 3);
////			Debug_addData(supercapacitor.ReceiveData.chassis_power, 4);//使用的功率
////			Debug_addData(supercapacitor.ReceiveData.chassis_buff, 5);//缓冲功率
